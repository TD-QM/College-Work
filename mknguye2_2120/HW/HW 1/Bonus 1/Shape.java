...
public abstract class Shape { 
	...
	/**
	 * Checks to see if the object both is the same shape and has the same base and height
	 * 
	 * @custom.ensure 	(obj instanceof Shape)
	 * @param 	obj 	A reference to another Shape
	 * @return			True if the object both is the same shape and has the same base and height
	 */
