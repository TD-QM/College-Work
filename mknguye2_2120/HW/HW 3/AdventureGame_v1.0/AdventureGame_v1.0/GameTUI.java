        ...
        while (itsDungeon.getHero().getHealth() > 0)
        {
            ...
            if(userInput.equals("save")){
                ...
                try{
                    ...
                    output = new ObjectOutputStream(Files.newOutputStream(Paths.get("SavedGame.dat"))); 
                    ...
                    File file = new File("./" + "SavedGame.dat"); // Make a file object with the name in the current directory
                ...
                try{
                    // Make a new InputStream object that looks at the file with then name saveName
                    input = new ObjectInputStream(Files.newInputStream(Paths.get("SavedGame.dat")));
