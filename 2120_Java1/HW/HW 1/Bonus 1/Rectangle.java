...
public class Rectangle extends Shape{
	...
	/**
	 * Calculates the difference between the base and the height of the object passed by a reference to this object see if they are similar.
	 * 
	 * @custom.ensure 	(obj instanceof Shape)
	 * @param 	obj 	A reference to another Shape
	 * @return			True if the object has the same base and height; false otherwise
	 */
	@Override
	public boolean equals(Object obj){
		if ((obj instanceof Rectangle) && 
			( Math.abs(((Rectangle) obj).getBase() - getBase()) < .001) && 
			( Math.abs(((Rectangle) obj).getHeight() - getHeight()) < .001)){
			return true;
		} else {
			return false;
		}
