...
Unknowing attempts at making a pseudo-AC3 Algorithm
This method revolves around an "Invalid List" for each of the cells that updates as elements are placed into the board
Theoretically shouldn't be faster than the backtracking
'''
